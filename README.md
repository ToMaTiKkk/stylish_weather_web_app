...
-   [x] **Интерактивная карта погоды:** При отображении прогноза также показывается карта (Leaflet.js с OpenStreetMap) с маркером в местоположении выбранного города. Маркер содержит краткую информацию о текущей погоде.
...
![Отображение города на карте](./city_map.png)
...
*   **Frontend:**
    ...
    *   **Leaflet.js:** Интерактивная JavaScript-библиотека для карт.
*   **База данных:**
